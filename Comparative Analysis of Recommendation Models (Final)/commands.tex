...
\cftsetindents{subsubsection}{3.2em}{2.6em}
...
\title{Comparative Analysis of Recommendation Models}
\newcommand{\theDegree}{Bachelor of Engineering in Computer Engineering}
